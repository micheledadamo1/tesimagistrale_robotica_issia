...
controller.lambda_theta=2.5
controller.Kvtheta=2.5
controller.lambda_x=20
controller.Kvx=10
...
plant.g=9.8 #annullo forza di gravità

r,rd,rdd,ang,angd,angdd=controller.reference_traj.data_export()
#
#r=[1,0,0]
#ang=[0,1,0]#cè sempre bisono di un angolo nella direzione altrimenti non si comporta bene
ang[1]=ang[1]+0.1
...
#plot.single_states_plot([data.x,data.y,data.z],[data.phi,data.theta,data.psi],time=time)
...
#plt.suptitle(['lambda_z=',controller.lambda_z,'; Kvz=',controller.Kvz,'; lambda_theta=',controller.lambda_theta,'; Kvtheta=', controller.Kvtheta])
...
##sliding surface
#plt.plot([0,1,-1],[0,-controller.lambda_y,controller.lambda_y],label='sliding surf')
#plt.plot(ey,eyd,label='sy')
#plt.legend()
#
